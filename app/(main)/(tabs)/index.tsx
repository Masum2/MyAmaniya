...
const { colorScheme } = useColorScheme();
  ...
  const nextAppointment = appointments?.find((a) => a.recordType === "Next Appointment");
  const pastAppointments = appointments?.filter((a) => a.recordType === "Past Appointment") || [];

  return (
    <View className="flex-1 bg-[#f8fafc] dark:bg-[#121212]">
      ...
      >
        <View className="px-5">
          <View className="mb-8 mt-4">
            ...
            <Text className="text-slate-500 dark:text-slate-400">Welcome back, {user?.fullName || "User"}</Text>
          </View>
          ...
          <View className="mb-8">
            ...
            {nextAppointment ? (
              ...
              <Text className="text-slate-400 dark:text-slate-500">No upcoming appointments.</Text>
            )}
          </View>
          ...
          <View>
            ...
            )) : <Text className="text-slate-400 dark:text-slate-500">No past records.</Text>}
          </View>
        </View>
      </ScrollView>
    </View>
